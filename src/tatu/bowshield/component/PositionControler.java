...
public class PositionControler {
	...
	public PositionControler(final String filepath1, String filepath2, float X,
			float Y) {
		...
		pSprite = new Sprite(X, Y, mRegion, GameSprite.getGameReference()
		...
		pSprite2 = new Sprite(X + 5, Y + 10, mRegion2, GameSprite
				.getGameReference().getVertexBufferObjectManager());
		GameSprite.getGameReference().getTextureManager()
				.loadTexture(mTexture2);
